class Story < ActiveRecord::Base
  ...
  def story_maker
    @characters = ["a giant","an Old Tree","a Sphinx","a Baron","a Knight","Puck","Fox","Wolf","Coyote","fairies", "the Emperor of San Francisco","a Gate","ghosts","a school of fish", "a mermaid", "a bird", "Augustine the Hunter","a man","a woman","Crow","a soldier","a banshee"]
    case die
    when 1..3
  ...
  def instructions_constructor
    instruction_intro = ["When you see","Make sure you bow before","If challenged by","If you step on the toes of","If given a riddle by","If offered food by","If you see","Do not quarrel with","If poisoned by","When facing a parliament of","Knock on the door of"]
